# Script PowerShell para atualizar GitHub com as correções atuais
...
# 6. DataContext - updateMenuVisibility melhorado
...
$commitMessage = "fix: Corrigir menu de visibilidade, botão hamburger e adicionar checkbox 'Não possui NF'
